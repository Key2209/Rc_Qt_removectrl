...
"}"));
    ...
    void retranslateUi(QWidget *ConnectWidget)
    {
        ...
        lbl_wifi_status->setText(QCoreApplication::translate("ConnectWidget", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:700;\">WIFI:</span></p></body></html>", nullptr));
