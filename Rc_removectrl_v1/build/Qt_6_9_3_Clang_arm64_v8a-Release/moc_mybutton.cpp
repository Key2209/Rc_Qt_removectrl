...
template <> constexpr inline auto MyButton::qt_create_metaobjectdata<qt_meta_tag_ZN8MyButtonE_t>()
{
    ...
    QtMocHelpers::UintData qt_properties {
        // property 'buttonMode'
        QtMocHelpers::PropertyData<enum ButtonMode>(6, 0x80000000 | 7, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag | QMC::StdCppSet),
    };
    QtMocHelpers::UintData qt_enums {
        // enum 'ButtonMode'
        QtMocHelpers::EnumData<enum ButtonMode>(7, 7, QMC::EnumFlags{}).add({
            {    8, ButtonMode::MomentaryMode },
            {    9, ButtonMode::ToggleMode },
        }),
    };
...
void MyButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->handleToggle((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::ReadProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast<enum ButtonMode*>(_v) = _t->getButtonMode(); break;
        default: break;
        }
    }
    if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setButtonMode(*reinterpret_cast<enum ButtonMode*>(_v)); break;
        default: break;
        }
    }
}
