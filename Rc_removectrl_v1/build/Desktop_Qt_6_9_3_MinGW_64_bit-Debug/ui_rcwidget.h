...
public:
    ...
    void setupUi(QWidget *RcWidget)
    {
        ...
        widget_2 = new MyScroller_Horiz(RcWidget);
        widget_2->setObjectName("widget_2");
        widget_2->setMinimumSize(QSize(500, 60));
        widget_2->setMaximumSize(QSize(300, 60));
        ...
        widget = new QWidget(RcWidget);
        widget->setObjectName("widget");
        widget->setMinimumSize(QSize(80, 180));
        widget->setMaximumSize(QSize(80, 180));
        ...
        Joystick_widget1_2 = new Joystick(RcWidget);
        Joystick_widget1_2->setObjectName("Joystick_widget1_2");
        Joystick_widget1_2->setMinimumSize(QSize(150, 150));
        Joystick_widget1_2->setMaximumSize(QSize(150, 150));

        horizontalLayout->addWidget(Joystick_widget1_2);
    ...
    void retranslateUi(QWidget *RcWidget)
    {
        ...
        pushButton_2->setText(QCoreApplication::translate("RcWidget", "C", nullptr));
        pushButton_3->setText(QCoreApplication::translate("RcWidget", "E", nullptr));
        pushButton_4->setText(QCoreApplication::translate("RcWidget", "B", nullptr));
        pushButton_5->setText(QCoreApplication::translate("RcWidget", "D", nullptr));
