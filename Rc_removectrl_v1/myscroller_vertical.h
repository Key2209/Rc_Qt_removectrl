#ifndef MYSCROLLER_VERTICAL_H
#define MYSCROLLER_VERTICAL_H
...
namespace Ui {
class MyScroller_vertical;
}

class MyScroller_vertical : public QWidget
{
    Q_OBJECT

public:
    explicit MyScroller_vertical(QWidget *parent = nullptr);
    ~MyScroller_vertical();
